        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="hero-description text-lg text-gray-600 dark:text-gray-300 mb-6 max-w-xl leading-relaxed">
              ...
              web, focusing on responsive design and modern web technologies.
            </p>
            ...
            <div className="hero-buttons flex flex-wrap gap-4 mb-8">
              <div className="button-item">
                <Button
                  asChild
                  size="lg"
                  className="bg-orange-500 hover:bg-orange-600 text-white bounce-in"
                >
            ...
            <div className="hero-social flex gap-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-full text-gray-600 hover:text-orange-500 hover:bg-gray-100 dark:text-gray-300 dark:hover:text-orange-400 dark:hover:bg-gray-800 transition-colors"
              >
                <Github size={24} />
              ...
              <a
                href="https://x.com/ahmed_muri50344?s=09"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-full text-gray-600 hover:text-orange-500 hover:bg-gray-100 dark:text-gray-300 dark:hover:text-orange-400 dark:hover:bg-gray-800 transition-colors"
              >
